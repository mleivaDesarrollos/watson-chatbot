(function(){
  ...
  function cambiarURL(id){
    switch (id) {
      case '1':
        iframe.src = "https://outlook.office365.com/owa";
        break;
      case '2':
        iframe.src = "https://portal.megatech.la:4068/wordpress/";
        break;
      case '3':
        iframe.src = "https://portal.megatech.la:2443/";
        break;
      case '4':
        iframe.src = "https://portal.megatech.la:4065/mscspd";
        break;
      case '5':
